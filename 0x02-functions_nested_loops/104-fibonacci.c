...
int main(void)
{
	...
	seq1_half1 = first_num / 1000000000;
	seq2_half1 = second_num / 1000000000;
	seq1_half2 = first_num % 1000000000;
	seq2_half2 = second_num % 1000000000;
	for (count = 93; count < 99; count++)
	{
		fh1 = seq1_half1 + seq2_half1;
		fh2 = seq1_half2 + seq2_half2;
		if (seq1_half2 + seq2_half2 > 999999999)
		{
			fh1 += 1;
			fh2 %= 1000000000;
		}
